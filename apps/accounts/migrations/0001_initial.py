    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('classe', models.CharField(blank=True, max_length=50, verbose_name='Classe / Filière')),
                ('etablissement', models.CharField(blank=True, max_length=100, verbose_name='Établissement')),
                ('avatar', models.ImageField(blank=True, null=True, upload_to='avatars/', verbose_name='Photo de profil')),
                ('date_inscription', models.DateTimeField(auto_now_add=True)),
                ('derniere_activite', models.DateTimeField(auto_now=True)),
                ('adresse_ip', models.GenericIPAddressField(blank=True, null=True, verbose_name='Dernière IP')),
